...
/**
 * Title: EmojiTest.class<br>
 * Description: <br>
 * Copyright (c) 人和网版权所有 2017 <br>
 * Create DateTime: 2017年9月12日 下午3:10:53 <br>
 *
 * @author gaoxing
 */
...
//			return str;
	...
	public static void main(String[] args) {
		System.out.println(convert("月亮之上"));
		String uni = convert("呀！土豆🍟").toLowerCase();
		System.out.println(revert(uni));
		System.out.println(emojiChange(revert("\\U5440\\Uff01\\U571f\\U8c46\\Ud83c\\Udf5f")));
	}
}
